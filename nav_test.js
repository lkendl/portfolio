...
class Nav extends HTMLElement {
    ...
    <nav class="navbar" id="desktop-nav">
        ...
        <div class="logo-txt">
            <a href="../../portfolio/index.html" class="logo-link">Laura Kendl</a>
        </div>
    ...
    <div class="menu-wrap">
        <div class="logo-wrap">
            <a href="../../portfolio/index.html"><img src="./img/white_kendl_logo.png" class="logo"></a>
        </div>
...
customElements.define("nav_test-component", Nav);